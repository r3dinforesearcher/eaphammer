...
def run(codec,
    ...
    for server in RELAY_SERVERS:
        ...
        s.setMode(mode, one_shot)
        if machine_account is not None and machine_hashes is not None and domain is not None:
            s.setDomainAccount( machine_account,  machine_hashes,  domain)
        elif (machine_account is None and machine_hashes is None and domain is None) is False:
